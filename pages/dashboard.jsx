...
export default function Dashboard() {
 ...
 .sidebar { width:280px; background: linear-gradient(180deg, #FF6B9D 0%, #C44569 50%, #A18CD1 100%); color:white; padding:25px 20px; position:fixed; height:100vh; overflow-y:auto; } /* FIX: overflow-y:auto add chesa */
 ...
 .hamburger { display:none; }
        @media (max-width: 1023px) {.sidebar { transform: translateX(-100%); position:fixed; z-index:999; }.sidebar.open { transform: translateX(0); }.main { margin-left:0; }.hamburger { display:block; position:fixed; top:15px; right:15px; background:#A18CD1; color:white; border:none; padding:12px 15px; border-radius:10px; font-size:22px; z-index:1000; } }
